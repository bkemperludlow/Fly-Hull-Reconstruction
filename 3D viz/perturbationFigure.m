...
axlim = [ 85 280 180 320 190 285 ]*imScale ;
...
%[flyGrp1, bodyGrp1, rightWingGrp1, leftWingGrp1, dL1, rightWingTip1, leftWingTip1] ...
%    = draw3Dfly(ax, scale, resolution, pinType, thetab0); %#ok<ASGLU>
[flyGrp2, bodyGrp2, rightWingGrp2, leftWingGrp2, dL2, rightWingTip2, leftWingTip2] ...
    = draw3Dfly_v3(ax, scale, resolution, pinType, thetab0); %#ok<ASGLU>
[flyGrp3, bodyGrp3, rightWingGrp3, leftWingGrp3, dL3, rightWingTip3, leftWingTip3] ...
    = draw3Dfly_v3(ax, scale, resolution, pinType, thetab0); %#ok<ASGLU>
[flyGrp4, bodyGrp4, rightWingGrp4, leftWingGrp4, dL4, rightWingTip4, leftWingTip4] ...
    = draw3Dfly_v3(ax, scale, resolution, pinType, thetab0); %#ok<ASGLU>
...
set(c,'ambientstrength',.7); % note that this line comes after "material shiny"
c = findobj(flyGrp4,'Type','surface');
set(c,'ambientstrength',.7); % note that this line comes after "material shiny"
%contrailDT = 18 ;
...
%setFlyDOF(flyGrp1, rightWingGrp1, leftWingGrp1, ...
%    bodyRcm(it1,:), bodyYPR(it1,:), rightYPR(it1,:) , leftYPR(it1,:), thetab0, dL1 )
setFlyDOF(flyGrp2, rightWingGrp2, leftWingGrp2, ...
    bodyRcm(it2,:), bodyYPR(it2,:), rightYPR(it2,:) , leftYPR(it2,:), thetab0, dL2 )
setFlyDOF(flyGrp3, rightWingGrp3, leftWingGrp3, ...
    bodyRcm(it3,:), bodyYPR(it3,:), rightYPR(it3,:) , leftYPR(it3,:), thetab0, dL3 )
setFlyDOF(flyGrp4, rightWingGrp4, leftWingGrp4, ...
    bodyRcm(it4,:), bodyYPR(it4,:), rightYPR(it4,:) , leftYPR(it4,:), thetab0, dL4 )
