...
% -------------------------------------------------------------------------
function [cost, g, H] = fitSimToDataLSQ(x, t_int, t_comp, s_0, thetaB0, ...
...
sol = simulatePitch(x(1:3), t_int, s_0, thetaB0, params, true, ...
    true, false) ;  % last 2 booleans: controlFlag=true, pertFlag=true,
...
if (t_max < t_int(end))
    ...
    cost = thetaB_sim_final - thetaB_data ; 
