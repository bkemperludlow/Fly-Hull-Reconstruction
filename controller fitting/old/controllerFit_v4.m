function controller_fit_struct = controllerFit_v4(data, ExprNum, MovNum, flyType, debugFlag, plotFlag) 
...
if isfield(data,'manualCorrRangeMS')
    ...
    manualCorrRangeMS_end = min([data.manualCorrRangeMS(2) 30]) ;
...
controller_fit_struct.flyType = flyType ;
%controller_fit_struct.sp_pitch = sp_pitch ;
