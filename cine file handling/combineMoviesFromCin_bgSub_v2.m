function stat = combineMoviesFromCin_bgSub_v2(metaData, outputFileName,fps,...
    realFrameRate,allBG,patch_color) 
...
%     keyboard ;
    ...
    for it = t:(t+N-1)
        ...
        % attempt to add colored bar for opto indicator
        if (realtimeMS >=0) && (realtimeMS <= 50)
             test_color_bar_im = insertShape(vid.frames(c).cdata,'FilledRectangle',...
                [1 1 35 35; 513 1 35 35 ; 1025 1 35 35 ],...
