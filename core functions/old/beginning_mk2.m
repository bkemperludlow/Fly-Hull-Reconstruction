...
errorPath = 'D:\Raymond Analysis Test\camera test automation\errorlog.txt' ;
...
job1 = batch('findBG_mk4',3,{cinFilenames{1}}) ;
job2 = batch('findBG_mk4',3,{cinFilenames{2}}) ;
job3 = batch('findBG_mk4',3,{cinFilenames{3}}) ;
...
disp(' ') ;
%}
% disp('about to do something stupid')
% blah = askjsprgsrjtyhpsjtb ; 
% disp('finished doing something stupid')
tic;
