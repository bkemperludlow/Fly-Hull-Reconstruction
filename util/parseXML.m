function  outStruct  = parseXML(input)
%parseXML converts xml file into a MATLAB structure
%
% outStruct = parseXML(input)
% 
...
% Name changed by Sam Whitehead, August 2021 (to not conflict with built-in
% MATLAB function
